...
当前 `.8` 候选改用仅中断 IN 的 HID 配置，主机 Output/Feature 全部经 EP0 接收，
避免 257 字节控制缓冲同时成为中断 OUT 接收长度，导致等待多个报告后才交付。
`.8` 已构建并通过实际固件描述符检查，尚未刷入，仍需真机复测。
...
- 前一版灰色直排名称候选（SHA-256 `e90bbfaff02c57fb885decb01b33dcec77d7ef1b8c91060738d1826453d97d85`）
  ...
  当前候选 4,368,528 字节，SHA-256 `b038f38502bcd6de7a9c86a15ed97eb52c17847b4db64479c7ab817321b461cf`，尚未刷入。
